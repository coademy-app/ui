...
const footerNavs = [
    ...
    { title: "Web dev", path: "webdev" },
    { title: "Courses", path: "courses" },
    { title: "Faqs", path: "faqs" },
    { title: "Blogs", path: "blogs" },
    { title: "What they say", path: "testimonials" },

]
const Footer = () => {
  return (
    <footer className="text-white bg-gray-900 px-4 pt-16 py-5  mx-auto ">
    ...
    <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
        {
            footerNavs.map((item, idx) => (
                <li key={idx} className=" hover:text-gray-800">
                    <Link key={idx} to={item.path} smooth={true} duration={500} className="cursor-pointer">
                        { item.title }
                    </Link>
                </li>
            ))
