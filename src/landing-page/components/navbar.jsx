...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`z-20 fixed top-0 border-b border-black/20 bg-white w-full md:text-sm ${state ? "shadow-lg rounded-b-xl md:shadow-none" : ""}`}
      >
        <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
          ...
          <div
            className={`nav-menu flex-1 pb-3 mt-8 z-40 md:block md:pb-0 md:mt-0 ${state ? "block" : "hidden"}`}
          >
