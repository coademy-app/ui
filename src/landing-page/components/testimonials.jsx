...
const testimonialsData = [
  {
    ...
    imageSrc: "https://images.pexels.com/photos/5490276/pexels-photo-5490276.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    stars: 5,
  },
  {
...
const Testimonials = () => {
  ...
  return (
    <section id='testimonials' className="py-16 lg:py-24 bg-white px-4 md:px-16">
      <div className="max-w-screen-xl mx-auto px-10 md:px-8 text-gray-900">
              ...
              <CarouselContent>
                {testimonialsData.map((testimonial, index) => (
                  <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-1">
                      <Card className="p-4 rounded-xl border border-black"
                        style={{
                          background: "#FFFFFF",
